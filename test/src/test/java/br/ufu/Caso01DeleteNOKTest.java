...
public class Caso01DeleteNOKTest extends NOKBaseTest {
    ...
    public void shouldCreateItem() throws Exception {
        ...
        String[] commands = getArgs(tempLogFile, 4465);
        ...
        await().dontCatchUncaughtExceptions().untilAsserted(() -> {
            ...
            assertEquals(splitCommads("DELETE 1"), readFileToString(tempLogFile, defaultCharset()));
