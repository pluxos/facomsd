        ...
        switch (opcao) {
            case 1:
                ...
                if (object.length > 1400) {
                    ...
                    ContextRequest contextRequest = ContextRequest.newBuilder().setInstruction(Utils.retornaTipoOperacao(opcao) + ";" + mapa.getChave() + ";" + mapa.getTexto()).build();
            ...
            case 3:
                ...
                if (objectDelete.length > 1400) {
                    ...
                    ContextServiceGrpc.ContextServiceBlockingStub stub = ContextServiceGrpc.newBlockingStub(channel);
                    ContextRequest contextRequest = ContextRequest.newBuilder().setInstruction(Utils.retornaTipoOperacao(opcao) + ";" + mapa.getChave()).build();
