...
import serverclient.client.consumer.AnswerPresentationThreadTest;
import serverclient.client.producer.CommandReaderThreadTest;
import serverclient.client.threads.ClientThread;
...
public class ClientThreadTest extends ClientThread {
    ...
    public ClientThreadTest(BlockingQueue<MessageOld> novasMensagens, BlockingQueue<MessageOld> novasRespostas) {
        this.novasMensagens = novasMensagens;
        this.novasRespostas = novasRespostas;
    }

    public synchronized BlockingQueue<MessageOld> getNovasMensagensQueue() {
        return this.novasMensagens;
    }

    public synchronized BlockingQueue<MessageOld> getNovasRespostasQueue() {
