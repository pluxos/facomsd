...
public class GraphStateMachine extends StateMachine {
    ...
    public Boolean AddItemFila(Commit<AddItemCommand> commit) {
        try {
            AddItemCommand aec = commit.operation();
    ...
    public Boolean GetItemFila(Commit<GetItemCommand> commit) {
        try {
            GetItemCommand aec = commit.operation();
            Item i = new Item(aec.getControll(), aec.getKey(), aec.getValue());
            System.out.println("Adding " + i);
