...
public class ClientServer extends JFrame implements ActionListener, KeyListener {
	...
	public ClientServer() throws IOException{                  
	    ...
	    JOptionPane.showMessageDialog(null, texts);              
	     ...
	     lblHistorico     = new JLabel("Tela");
	     lblMsg        = new JLabel("Comando");
	     btnSend                     = new JButton("Enviar");
	     btnSend.setToolTipText("Enviar Mensagem");
	     btnSair           = new JButton("Sair");
	     btnSair.setToolTipText("Sair da Tela");
	     btnCreate           = new JButton("Create");
	     btnSair.setToolTipText("Item criado");
	     btnUpdate          = new JButton("Update");
	     btnSair.setToolTipText("Item Atualizado");
	     btnDelete           = new JButton("Delete");
	     btnSair.setToolTipText("Item deletado");
	     btnRead           = new JButton("Read");
	     btnSair.setToolTipText("Lendo Item");
	   ...
	   public void actionPerformed(ActionEvent e) {
	     ...
	     try {
	        if(e.getActionCommand().equals(btnSend.getActionCommand())) {
	           enviarComando(txtMsg.getText());
	           }
	        if(e.getActionCommand().equals(btnCreate.getActionCommand())) {
	        	enviarComando(txtMsg.getText());
		           }
	         if(e.getActionCommand().equals(btnDelete.getActionCommand())) {
	        	 enviarComando(txtMsg.getText());
		           }
	         if(e.getActionCommand().equals(btnUpdate.getActionCommand())) {
	        	 enviarComando(txtMsg.getText());
		           }
